    ...
    return (
        <div className="z-40 w-full flex items-center bg-gray-950 text-white h-14 text-xl justify-end fixed font-sans shadow-md">
         ...
         <div className="flex items-center justify-between">
           <h2 className="ml-3 sm:ml-28 font-bold text-white font-mono">Brian Yost</h2>
           <div className="hidden sm:flex justify-end">
            <Link href="/" className="mx-3 transform transition hover:text-gray-500">
              Inicio
             </Link>
             <Link href="/about" className="mx-3 transform transition hover:text-gray-500">
               Sobre Mi
             </Link>
             <Link href="/service" className="mx-3 transform transition hover:text-gray-500">
               Servicios
             </Link>
