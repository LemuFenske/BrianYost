  ...
  return (
    <div className="relative h-screen w-full bg-gray-600 flex justify-center items-center">
      ...
      <div className="z-20 absolute w-[90%] md:w-[60%] px-4 md:px-0 flex flex-col justify-center items-start">
        <h1 className="text-5xl text-gray-400 font-black italic my-3 font-mono">MIS SERVICIOS</h1>
        <h2 className="text-xl my-3">Me especializo en crear planes de entrenamiento 100% personalizados según tus objetivos, necesidades y nivel de entrenamiento. No dejes tu preparación física al azar y asesórate con un profesional.</h2>
